      ...
      .filter((product) => {
        ...
        if (searchQuery) {
          ...
          const matches = 
            ...
            ((product as { customSection?: string }).customSection || '').toLowerCase().includes(query);
                    ...
                    >
                      ...
                      <div className="p-3 sm:p-4 flex flex-col grow">
                        ...
                        <Link 
                          ...
                          className="hover:text-primary transition-colors line-clamp-2 text-xs sm:text-sm font-black text-navy mb-2 grow leading-snug"
                        >
                          {product.name}
                        </Link>
