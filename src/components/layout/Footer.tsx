...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#070a0f] text-white pt-10 md:pt-14 pb-8 pb-safe-bottom print:hidden border-t border-[#1e2638] transition-colors">
      <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5 text-[11px] font-bold text-gray-300">
                <span className="px-2.5 py-1 border border-[#273142] rounded-lg bg-[#141b26]">Cash on Delivery</span>
              </div>
            </div>
          </div>
        ...
        {/* Copyright */}
        <div className="pt-6 border-t border-[#1e2638] text-center text-xs text-gray-500">
